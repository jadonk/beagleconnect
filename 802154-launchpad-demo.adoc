...
This repository utilizes (git
submodules)[https://git-scm.com/book/en/v2/Git-Tools-Submodules] to keep
...
must be: * specifications for authentication and encryption *
...
`export ZEPHYR_TOOLCHAIN_VARIANT=zephyr     export ZEPHYR_SDK_INSTALL_DIR=~/zephyr-sdk-0.11.2`
...
this:
`console     ...     Memory region         Used Size  Region Size  %age Used                FLASH:      261996 B         1 MB     24.99%                 SRAM:       50879 B       256 KB     19.41%             IDT_LIST:         152 B         2 KB      7.42%     [245/245] Linking C executable zephyr/zephyr.elf`
