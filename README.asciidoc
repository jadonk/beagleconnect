...
Connect _BeagleConnect™ Freedom_ via USB while holding the USER button.
...
Disconnect and reconnect _BeagleConnect™ Freedom_ via USB while holding the USER button.
...
Disconnect and reconnect _BeagleConnect™ Freedom_.
