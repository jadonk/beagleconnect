...
BeagleConnect Leash wireless hardware is built around a
...
could be a built-in interface device or one connected over USB. `BeagleConnect Leash` can provide
this function.
...
BeagleConnect gateway device:: http://www.ti.com/tool/launchxl-cc1352r1[CC1352R Launchpad]
BeagleConnect node device:: * http://www.ti.com/tool/launchxl-cc1352r1[CC1352R Launchpad] and https://www.mikroe.com/click-booster-pack-2[Click BoosterPack 2]
