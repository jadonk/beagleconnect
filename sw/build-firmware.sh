...
west build -p always -b beagleconnect_freedom -d $PWD/build/wpanusb_beagleconnect $PWD/../wpanusb_bc -- -DOVERLAY_CONFIG=overlay-subghz.conf
...
west build -p always -b beagleconnect_freedom -d $PWD/build/wpanusb_beagleconnect_2G $PWD/../wpanusb_bc
